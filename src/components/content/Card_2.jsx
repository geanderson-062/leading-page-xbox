    ...
    return (
        ...
        <>
          <div className="card bg-dark text-white">
            <img src={xbox2} className="card-img" />
          <div className="card-img-overlay">
              <h5 className="card-title">Novas Cores & Maior Compatibilidade.</h5>
               <p className="card-text">
               Com o controle Xbox Series você pode utilizar no seu Xbox Series X e S 
               e no Xbox One e PC .
               </p>
