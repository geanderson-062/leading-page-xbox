    ...
    return (
        ...
        <>
          <div className="card bg-dark text-white">
            <img src={xbox3} className="card-img" />
          <div className="card-img-overlay">
              <h5 className="card-title">Controle mais confortavel do mercado</h5>
               <p className="card-text">Designer ergonômico e Confortavel para longas horas de jogatina.</p>
